...
class Category(TimeStampedModel):
    ...
    shor_name = models.CharField('Nombre corto', max_length=15, unique=True)
...
class Entry(TimeStampedModel):
    ...
    def save(self, *args, **kwargs):
        ...
        #generamos un numero del total de segundos
        seconds = int(total_time.total_seconds())
        #concatenamos el titulo con los segundos totales
        slug_unique = '%s %s' % (self.title, str(seconds))
        #concertimos en string en un slug
